...
if __name__ == "__main__":
    ...
    # (id serial NOT NULL PRIMARY KEY, product_id varchar(10) NOT NULL,
    # title varchar(100) NOT NULL, product_type varchar(100) NOT NULL,
    # price numeric(6, 2) NOT NULL, custom_label_0 numeric(6, 2) NOT NULL);"
    # """
    # cur.execute(query)
    ...
    for element in root.iter("item"):
        ...
        try:
            cur.execute(
                ...
                (product_id, title, product_type, price, custom_label_0)
                VALUES (%s, %s, %s, %s, %s)
                """,
                (product_id, title, product_type, price, custom_label_0),
            )
