...
* [Django] (3.1): a high-level [Python] Web framework that encourages rapid development and clean, pragmatic design.
...
(codetest37)~/codetest$ pip install pip==20.2.2
(codetest37)~/codetest$ pip install setuptools==49.6.0
